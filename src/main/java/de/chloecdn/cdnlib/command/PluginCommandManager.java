...
public class PluginCommandManager {
     ...
     */
    @Deprecated
    public static void register(@NotNull String command, @NotNull RunAction runAction) {
     ...
     * @param runAction         the action to perform when someone runs the command.
     */
    public static void registerVanilla(@NotNull String command, @NotNull RunAction runAction) {
